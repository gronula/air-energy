...
var windowScrollHandler = function () {
  ...
  setTimeout(function () {
    var feedbackTop = feedback.offsetTop - innerHeight;
    ...
    if (innerWidth >= 1024) {
      ...
      if (!document.querySelector('.bestsellers__products').classList.contains('slick-initialized')) {
        $('.bestsellers__products').slick({
          ...
          arrows: true,
          infinite: true,
          appendArrows: $('.bestsellers__controls'),
          prevArrow: $('.bestsellers__controls .bestsellers__button--previous'),
          nextArrow: $('.bestsellers__controls .bestsellers__button--next'),
        });
      }
    }
  });
