...
var filterRemoveButton = filter.querySelector('.filter__remove');
var comparisonDeleteButtons = main.querySelectorAll('.comparison__delete');
...
var filterRemoveButtonClickHandler = function (evt) {
  evt.preventDefault();

  var blocks = $('.comparison__header');
  ...
  var filterControls = filter.querySelector('.filter__controls');
...
var comparisonDeleteButtonHandler = function (button) {
  button.addEventListener('click', function (evt) {
    ...
    var order = $('.slick-slide').index(evt.target.parentElement);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  filterRemoveButton.addEventListener('click', filterRemoveButtonClickHandler);

  for (i = 0; i < comparisonDeleteButtons.length; i++) {
    comparisonDeleteButtonHandler(comparisonDeleteButtons[i]);
  }
...
$(document).ready(function () {
  $(window).on('load', function () {
    if (!document.querySelector('.comparison__block').classList.contains('slick-initialized')) {
      ...
      $('.comparison__block:not(.comparison__block--images)').slick({
        dots: false,
        arrows: false,
        infinite: false,
        slidesToShow: 2,
